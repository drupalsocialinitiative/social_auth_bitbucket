...
class BitbucketAuthController extends OAuth2ControllerBase {
  ...
  public function __construct(MessengerInterface $messenger,
    ...
    parent::__construct('Social Auth Bitbucket', 'social_auth_bitbucket', $messenger, $network_manager, $user_authenticator, $bitbucket_manager, $request, $data_handler);
  }
  ...
  public function callback() {
    ...
    if ($profile !== NULL) {
      ...
      // Gets email address.
      $emails = json_decode($this->providerManager->requestEndPoint('/2.0/user/emails'), TRUE);
      $email = '';
      ...
      return $this->userAuthenticator->authenticateUser($profile->getName(), $email, $profile->getId(), $this->providerManager->getAccessToken(), $profile->toArray()['links']['avatar']['href'], $data);
    }
